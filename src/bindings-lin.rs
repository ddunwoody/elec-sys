...
extern "C" {
    #[link_name = "\u{1}libelec_add_user_cb"]
    pub fn add_user_cb(
        sys: *mut elec_sys_t,
        pre: bool,
        cb: elec_user_cb_t,
...
extern "C" {
    #[link_name = "\u{1}libelec_remove_user_cb"]
